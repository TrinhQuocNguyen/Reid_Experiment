...
# Market to Duke
python model_test_study.py -dt duke --data-dir /mnt/AIProjects/trinh/DATA/reid --resume logs/market2duke_merge/target_fine_tuning/model_best.pth.tar --num-classes 900