...
# duke-to-market merge
python target_train.py -dt market --data-dir /mnt/AIProjects/trinh/DATA/reid --logs-dir logs/duke2market_merge_resnet152/target_fine_tuning --initial-weights logs/duke2market_merge_resnet152 -b 64 --arch resnet152 --num-clusters 700
